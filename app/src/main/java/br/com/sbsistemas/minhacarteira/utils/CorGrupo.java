...
public class CorGrupo {
    ...
    private static final Map<String, Integer> iconeGrupo = new HashMap<>();
    ...
    static {
        ...
        iconeGrupo.put(GrupoDAO.GRUPO_MORADIA,  R.drawable.grupo_moradia_peq);
        iconeGrupo.put(GrupoDAO.GRUPO_SAUDE,  R.drawable.grupo_saude_peq);
        iconeGrupo.put(GrupoDAO.GRUPO_EDU_TRAB,  R.drawable.grupo_trabalho_peq);
        iconeGrupo.put(GrupoDAO.GRUPO_TRANSPORTE, R.drawable.grupo_transporte_peq);
    }

    public Integer getCor(String descricaoGrupo){
        Integer[] cor = corDoGrupo.get(descricaoGrupo);
        return Color.rgb(cor[0], cor[1], cor[2]);
    }

    public Integer[] getCorRGB(String descricao){
        return corDoGrupo.get(descricao);
    }

    public int getIcone(String descricaoGrupo) {
        return iconeGrupo.get(descricaoGrupo);
    }
